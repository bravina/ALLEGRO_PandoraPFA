...
parser.add_argument("--pandoraSettings", help="Pandora settings file", default="PandoraSettingsDefault.xml")
...
if runPandora:
    print("PandoraPFA is requested, will set addTracks, runHCal and runMuon to True")
    runHCal = True
    runMuon = True
    addTracks = True
...
if runHCal:
    ...
    calibHCalBarrel = CalibrateCaloHitsTool(
        "CalibrateHCalBarrel", invSamplingFraction="31.09")
    # HCAL endcap
    calibHCalEndcap = CalibrateCaloHitsTool(
        "CalibrateHCalEndcap", invSamplingFraction="31.09")
...
#            "ECAL_Endcap": ecalEndcapReadoutName,
        ...
        setupTopoClusters(CaloTopoClusterInputs,
                          ...
                          "CaloTopoClusters",
                          0.0,
                          dataFolder + "neighbours_map_ecalB_hcalB_hcalE.root",
                          dataFolder + "cellNoise_map_electronicsNoiseLevel_ecalB_hcalB_hcalE.root",
                          False,
                          False,
                          False,
                          False)
...
if runPandora:
    ...
    pandora.Parameters = {
        "PandoraSettingsXmlFile": [opts.pandoraSettings],
        "ECalMipThreshold": ["0."],
        "HCalMipThreshold": ["0."],
        "ECalToHadGeVCalibrationEndCap": ["1."],  # this must be calculated for ALLEGRO
        "ECalToHadGeVCalibrationBarrel": ["1.1927"],
        "HCalToHadGeVCalibration": ["1.1945"],
        "ECalToMipCalibration": ["100.0"],
        "HCalToMipCalibration": ["100.0"],
        #"ECalBarrelToMipCalibration": ["260.", "45.", "45.", "45.", "40.", "40.", "40.", "40.", "30.", "30.", "30."],
        #"HCalBarrelToMipCalibration": ["20.", "20.", "20", "20", "10", "10.", "10.", "10", "10.", "10.", "5.", "5.", "5."],
        "DigitalMuonHits": ["0"],
        "MaxHCalHitHadronicEnergy": ["1000000000000."],
        ...
        "HadConstantTerm": ["0.035"], # ALLEGRO standalone-HCAL kaon0L resolution
        "HadStochasticTerm": ["0.41"], # ALLEGRO standalone-HCAL kaon0L resolution
    }
    TopAlg += [pandora]
    ...
    pfoAnalysis.Parameters = {
        ...
        "HCalCollections"                   : [hcalBarrelPositionedCellsName,hcalEndcapPositionedCellsName],
        ...
        "HCalEndcapCollectionsSimCaloHit"   : [hcalEndcapReadoutName],
